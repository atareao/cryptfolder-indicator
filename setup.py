...
DATA_FILES = [
	('/opt/extras.ubuntu.com/cryptfolder-indicator/bin',glob.glob('bin/*')),
	('/opt/extras.ubuntu.com/cryptfolder-indicator/share/cryptfolder-indicator',glob.glob('src/*.py')),	
	('/opt/extras.ubuntu.com/cryptfolder-indicator/share/cryptfolder-indicator/pexpect',glob.glob('src/pexpect/*.py')),	
	('/opt/extras.ubuntu.com/cryptfolder-indicator/share/cryptfolder-indicator',['debian/changelog']),	
	('/opt/extras.ubuntu.com/cryptfolder-indicator/share/cryptfolder-indicator/social',glob.glob('data/social/*.svg')),
	('/opt/extras.ubuntu.com/cryptfolder-indicator/share/cryptfolder-indicator/icons',glob.glob('data/icons/*.svg')),
	('/opt/extras.ubuntu.com/cryptfolder-indicator/share/pixmaps',['data/icons/cryptfolder-indicator.svg']),	
	('/opt/extras.ubuntu.com/cryptfolder-indicator/share/cryptfolder-indicator',['data/cryptfolder-indicator-autostart.desktop']),
	('/usr/share/applications',['data/extras-cryptfolder-indicator.desktop']),	
	]
...
class install_data(_install_data):
	def run(self):
		for lang in os.listdir('build/locale-langpack/'):
			lang_dir = os.path.join('/opt/extras.ubuntu.com/cryptfolder-indicator/share', 'locale-langpack', lang, 'LC_MESSAGES')
